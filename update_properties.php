    ...
    <div class=" d-flex w-100 h-100 mx-auto flex-column">
        ...
        <div class="container-fluid text-start">
            ...
            <div class="text-center">
                <h2 class="text-center">Listado de hallados en el archivo <?php echo $filenameCSV; ?></h2>            
                <p class="">Actualización del listado de bienes!</p>                    
            </div>
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <?php include('properties/table/propertiesCsv.php'); ?>
                        </div>
                    </div>
                </div>
            </div>
